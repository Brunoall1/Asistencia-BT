...
import { PlusCircle, LogIn, CalendarDays, List, KeyRound, X, CheckCircle, ArrowLeft } from 'lucide-react';
...
const AdminHome = () => {
    ...
    return (
        <div className="home-container">
            <button className="back-button glass-btn" onClick={() => navigate('/')} style={{ top: '2.5rem', left: '2.5rem', position: 'absolute', zIndex: 100 }}>
                <ArrowLeft size={18} />
                Inicio
            </button>
